# -*- coding: utf-8 -*-
"""
Created on Mon Apr 24 11:20:20 2023
...
class RRTMap: #methods for drawing map, obstacles and path
    def __init__(self, start, goal, MapDimensions, obsdim, obsnum):
        ...
        self.map = pygame.display.set_mode((600, 600))
    ...
    def drawStuff(self,X,Y,Parents):
        for i in range(len(X)-1):
            ...
            pygame.draw.circle(self.map, self.Blue, (X[-i], Y[-i]), self.nodeRad + 2, 0)
...
class RRTGraph: # methods to make and remove nodes and edges, check the collisions and find the nearest neighbor to a sample
    ...
    def makeRandomRect(self):
        ...
        x_box = [100,300,100,300]
        y_box = [100,100,300,300]
    ...
    def makeobs(self):
        obs = []
        obsbbox=[]
        length_wall = [30,30,30,30]
        width_wall = [30,30,30,30]
        length_box = [150,150,150,150]
        width_box = [150,150,150,150]
    ...
    def sample_envir(self):
        x = int(random.uniform(50, self.mapw))
        y = int(random.uniform(50, self.maph))
        return x, y
